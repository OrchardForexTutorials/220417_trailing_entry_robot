# Trailing Entry Robot

Trails an entry price for both buy and sell entry behind the market price.
Similar to a trailing stop but applies to the entry price.
